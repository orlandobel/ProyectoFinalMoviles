        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-1">
                    ...
                    <button type="button" class="btn btn-block bg-gradient-success btn-sm" data-toggle="modal" data-target="#myModal"> Nueva </button>
						      ...
						      <div class="modal-body">
								 <form>
							          <div class="form-group">
							            <input class="form-control form-control-navbar" type="Asunto" placeholder="Asunto" aria-label="Search">
							          </div>

							          <div class="form-group">
							            <textarea class="form-control form-control-navbar"type="Descripcion" placeholder="Descripcion" aria-label="Descripcion" id="message-text"></textarea>
							          </div>
							          ...
							          <div class="form-group">
					                    ...
					                    <div class="dropdown-menu" style="">
					                      ...
					                      <a class="dropdown-item" href="#">Graduado</a><div class="dropdown-divider"></div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
								 <form>
							          <div class="form-group">
							          		<div class="row">
									          <div class="col-md-4"><label for="recipient-name" class="control-label">Asunto:</label></div>
							          ...
							          <div class="form-group">
							          		<div class="row">
									          <div class="col-md-4"><label for="recipiente-desti" class="control-label">Destinatarios:</label> </div>
							          ...
							          <div class="form-group">
							          		<div class="row">
									          <div class="col-md-4"><label for="recipiente-Descrip" class="control-label">Descripcion:</label> </div>
							          ...
							          <div class="form-group">
							          		<div class="row">
									          <div class="col-md-4"><label for="recipiente-Fecha" class="control-label">Fecha:</label> </div>
                        ...
                        <tr>
                            ...
                            <td>
                            <div class="btn-group">
                            	 <a href="#m2" data-toggle="modal">Ver</a>
                        ...
                        <tr>
                            ...
                            <td>
                            <div class="btn-group">
                                 <a href="#m3" data-toggle="modal">Ver</a>
                            </div>
                            </td>
                        </tr>
                        <tr>
